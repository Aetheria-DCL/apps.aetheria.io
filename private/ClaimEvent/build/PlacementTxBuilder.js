...
var PlacementTxBuilder = (function () {
    ...
    PlacementTxBuilder.prototype.buildManyTx = function (plotArray, addr) {
        return __awaiter(this, void 0, void 0, function () {
            var retval, chunks;
            var _this = this;
            return __generator(this, function (_a) {
                retval = [];
                chunks = this.chunkArray(plotArray, 100);
                chunks.forEach((function (plots) {
                    retval.push(_this.buildTx(plots, addr));
                }).bind(this));
                return [2, retval];
            });
        });
    };
    PlacementTxBuilder.prototype.chunkArray = function (array, chunkSize) {
        var tmp = [];
