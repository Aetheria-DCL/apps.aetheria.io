...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/socket.io-client */ \"./lib/socket.io-client.js\");\n/* harmony import */ var _lib_socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_socket_io_client__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _authenticator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./authenticator */ \"./authenticator.js\");\n/* harmony import */ var _userInterface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userInterface */ \"./userInterface.js\");\n/* harmony import */ var _metamaskInterface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./metamaskInterface */ \"./metamaskInterface.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nclass WebApp \r\n{\r\n    constructor(debug)\r\n    {\r\n        let metamaskInstance = new _metamaskInterface__WEBPACK_IMPORTED_MODULE_3__[\"MMInterface\"]();\r\n        let socket = this.buildSocket(debug);\r\n\r\n        let uiInstance = new _userInterface__WEBPACK_IMPORTED_MODULE_2__[\"UserInterface\"](socket, metamaskInstance);\r\n        let auth = new _authenticator__WEBPACK_IMPORTED_MODULE_1__[\"Authenticator\"](socket, metamaskInstance, (data) => {\r\n            uiInstance.authed(data);\r\n        });\r\n        auth.startAuth();\r\n    }\r\n\r\n    buildSocket(DEBUG)\r\n    {\r\n        let socket = null;\r\n        if (DEBUG) {\r\n            socket = _lib_socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(\"localhost:10002\");\r\n        } else {\r\n            socket = _lib_socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(\"apps.aetheria.io:10002\");\r\n        }\r\n        return socket;\r\n    }\r\n}\r\n\r\nfunction isLocalDev()\r\n{\r\n    return !window.location.href.includes(\"aetheria.io\")\r\n}\r\n\r\nnew WebApp(isLocalDev());\r\n\n\n//# sourceURL=webpack:///./main.js?");
...
/***/ "./metamaskInterface.js":
/*!******************************!*\
  !*** ./metamaskInterface.js ***!
  \******************************/
/*! exports provided: MMInterface */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MMInterface\", function() { return MMInterface; });\nclass MMInterface\r\n{\r\n    constructor()\r\n    {\r\n        this.w3 = null;\r\n\r\n        if (window.ethereum) {\r\n            this.w3 = new Web3(ethereum);\r\n            try {\r\n                // Request account access if needed\r\n                ethereum.enable();\r\n            } catch (error) {\r\n                window.history.back();\r\n            }\r\n        }\r\n        // Legacy dapp browsers...\r\n        else if (window.web3) {\r\n            this.w3 = new Web3(web3.currentProvider);\r\n        }\r\n    }\r\n\r\n    requestSigning(chal, addr)\r\n    {\r\n        return new Promise((res) => {\r\n            this.w3.personal.sign(chal, addr, \"\", (err, sig)=>{\r\n                res(sig);\r\n            });\r\n        });\r\n    }\r\n\r\n    getMainAccount()\r\n    {\r\n        return this.w3.eth.accounts[0];\r\n    }\r\n}\r\n\r\n\n\n//# sourceURL=webpack:///./metamaskInterface.js?");
